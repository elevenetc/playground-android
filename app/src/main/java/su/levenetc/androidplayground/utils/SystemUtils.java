...
public class SystemUtils {
	...
	public static @Nullable Point getPhotoDimens(Context context, Uri imageUri) throws IOException {
	...
	public static @Nullable ExifInterface getExif(Context context, Uri imageUri) throws IOException {
	...
	@SuppressLint("NewApi") public static void increaseWebViewTextSize(WebView webView) {
	...
	@SuppressLint("NewApi") public static void copyText(String text, Context context) {
		int sdk = android.os.Build.VERSION.SDK_INT;
		if (sdk < android.os.Build.VERSION_CODES.HONEYCOMB) {
